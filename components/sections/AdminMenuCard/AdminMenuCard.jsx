...
import styles from '@/components/sections/AdminMenuCard/AdminMenuCard.styles';
...
export default function SgSectionAdminMenuCard({extraItems = []}) {
...
//                     <TouchableOpacity onPress={() => router.push('/pages/info')} style={styles.item}>
//                         <View style={styles.left}>
//            cx  p; nm nAzxdsgwef                 <View style={styles.iconContainer}>
//                                 <AppInfo width={20} height={20} style={styles.icon}/>
//                             </View>
